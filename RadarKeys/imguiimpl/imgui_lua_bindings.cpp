// modified a little since main repo hasn't been updated since imgui 1.60 https://github.com/ZhuRong-HomoStation/imgui_lua_bindings
#include <stdio.h>
#include <imgui.h>
#include <deque>
// #include "imgui_lua_binding.h" // no idea what this is. can't find any traces of this being used. disabling for now...
#include "lua.h"
#include "lualib.h"
#include "lauxlib.h"
//using namespace slua; // no idea what this is. can't find any traces of this being used. disabling for now...
...
void LoadImguiBindings(lua_State* lState) {
  ...
  lua_newtable(lState);
 // ver 501 luaL_setfuncs(lState, imguilib, 0);
