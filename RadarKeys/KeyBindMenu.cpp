...
namespace RadarKeys {
	...
	namespace KeyBindMenu {
		...
		const VkNameEntry xboxVkNameTable[] = {
			{"XBox A", VK_GAMEPAD_A}, {"XBox B", VK_GAMEPAD_B},
			{"XBox X", VK_GAMEPAD_X}, {"XBox Y", VK_GAMEPAD_Y},
			{"XBox LB", VK_GAMEPAD_LEFT_SHOULDER}, {"XBox RB", VK_GAMEPAD_RIGHT_SHOULDER},
			{"XBox LT", VK_GAMEPAD_LEFT_TRIGGER}, {"XBox RT", VK_GAMEPAD_RIGHT_TRIGGER},
			{"XBox Menu", VK_GAMEPAD_MENU}, {"XBox View", VK_GAMEPAD_VIEW},
			{"XBox Up", VK_GAMEPAD_DPAD_UP}, {"XBox Down", VK_GAMEPAD_DPAD_DOWN},
			{"XBox Left", VK_GAMEPAD_DPAD_LEFT}, {"XBox Right", VK_GAMEPAD_DPAD_RIGHT},
			{"LS Up", VK_GAMEPAD_LEFT_THUMBSTICK_UP}, {"RS Up", VK_GAMEPAD_RIGHT_THUMBSTICK_UP},
